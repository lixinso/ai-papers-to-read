...
|-------|------|--------|------|------|
| Intuitive physics understanding emerges from self-supervised pretraining on natural videos | https://arxiv.org/pdf/2502.11831 | - | - |  V-JEPA --a self-supervised video model |
